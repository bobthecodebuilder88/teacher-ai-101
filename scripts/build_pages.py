...
PAGES = [
 ...
 dict(path="/exam-questions/", lv="go", cat="eval", crumb="평가",
      sids=["exam-ait-what","exam-ait-make","exam-ait-choice","exam-ait-check","exam-ait-src"],
      spa="#eval",
      title="AI 시험문제 출제 - 복사해 쓰는 프롬프트와 검토 체크리스트 | AI로운 교사생활",
      desc="서·논술형 문항과 채점 루브릭을 한 세트로 받는 프롬프트, 선택형 매력적 오답 프롬프트, 출력 전 검토 체크리스트 5가지를 교육부 자료 기반으로 정리했습니다."),
